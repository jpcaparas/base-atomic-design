...
<html lang="en" dir="ltr">
    ...
    <body>
        <main role="main" class="style-guide">
            ...
            <header role="heading" class="constrain-width">
                <h1>Style Guide</h1>
            ...
            <section class="constrain-width">
                ...
                <p>
                    ...
                    <button class="button secondary" href="#">Secondary Button</button>
